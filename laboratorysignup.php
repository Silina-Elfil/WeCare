...
<head>
    ...
    <title>WeCare - LABORATORY sign up</title>
    ...
    if (isset($_POST['signup'])) {
        ...
        if ($count_name === 0 && $count_email === 0) {
            if ($password == $vpassword) {
                ...
                VALUES('$username', '$email', '$hash', 5)";
                $result3 = mysqli_query($con, $query3);

                if ($result3) {
                    // Get the last inserted user ID
                    $labId = mysqli_insert_id($con);

                    // Now use this $drId when inserting into drprofile
                    $query4 = "INSERT INTO labprofile(labId)
                                VALUES('$labId')";
         ...
         header("Location: laboratorysignup.php");
         exit();
    }
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-7 px-md-5 py-md-5">
                    ...
                    <h5>CREATE AN ACCOUNT AS A LABORATORY</h5>
                    ...
                    <p class="mt-5">Not a lab? <a href="signup.php">Sign Up using other methods</a></p>
